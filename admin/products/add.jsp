...
<% request.setCharacterEncoding("UTF-8");  %>
	...
	action="${pageContext.request.contextPath}/AddProductServlet" method="post">
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				<td align="center" bgColor="#e1e9dd" colSpan="4" height="26"><strong><STRONG>添加商品</STRONG>
				</strong></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td bgColor="#ffffff"><input type="text" name="pnum" /></td>
			...
			<tr>
				...
				<td bgColor="#ffffff" colspan="3"><input type="file"
					name="imgurl" accept=".jpg (*.jpg),.gif (*.gif)" size="30" value="" />
				</td>
			</tr>
			<tr>
				<td align="center" bgColor="#f5fafe">商品描述：</td>
				<td bgColor="#ffffff" colSpan="3"><textarea name="description"
						cols="30" rows="3" style="WIDTH: 96%"></textarea></td>
			</tr>
			<tr>
